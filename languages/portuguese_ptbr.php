...
$LNG['user_exists'] = 'Este usuário já existe';
$LNG['email_exists'] = 'Este e-mail já está em uso';
$LNG['all_fields'] = 'Todos os campos são obrigatórios';
$LNG['user_alnum'] = 'O nome de usuário deve conter apenas de letras e números';
$LNG['user_too_short'] = 'O nome de usuário deve ter entre 3 e 32 caracteres';
$LNG['user_limit'] = 'Muitas contas foram criadas através deste IP';
$LNG['invalid_email'] = 'E-mail inválido';
$LNG['activate_email'] = 'Um link de confirmação foi enviado para o seu e-mail';
$LNG['account_activated'] = 'Sua conta foi ativada';
$LNG['invalid_user_pw'] = 'Usuário ou senha inválidos';
$LNG['invalid_captcha'] = 'Captcha inválido';
$LNG['log_out'] = 'Sair';
$LNG['hello'] = 'Olá';
$LNG['connect'] = 'Fazer Login';
$LNG['register'] = 'Registrar-se';
$LNG['login'] = 'Login';
$LNG['password'] = 'Senha';
$LNG['username'] = 'Usuário';
$LNG['email'] = 'E-mail';
$LNG['captcha'] = 'Captcha';
$LNG['username_or_email'] = 'Usuário ou senha';
$LNG['welcome_desc'] = 'compartilhe suas músicas, conecte-se com artistas, explore novos conteúdos';
$LNG['join_now'] = 'Entrar';
$LNG['learn_more'] = 'Saiba mais';
$LNG['creators'] = 'Criadores';
$LNG['listeners'] = 'Ouvintes';
$LNG['audience'] = 'Audiência';
$LNG['organize'] = 'Organize';
$LNG['featured'] = 'Destaque(s)';
$LNG['popular'] = 'Popular';
$LNG['latest'] = 'Mais recentes';
$LNG['upload_desc'] = 'Faça o upload do(s) seus sons, músicas e podcasts para o mundo';
$LNG['audience_desc'] = 'Conecte-se à nossa comunidade e aumente seu público';
$LNG['statistics_desc'] = 'Conheça seu público ouvinte com estatísticas avançadas';
$LNG['explore_desc'] = 'Explore e transmita músicas, conecte-se com novos artistas';
$LNG['share_desc'] = 'Compartilhe suas músicas favoritas com seus amigos nas redes sociais';
$LNG['organize_desc'] = 'Crie listas de reprodução e organize sua música da maneira que quiser';
$LNG['forgot_password'] = 'Esqueceu sua senha?';
$LNG['all_rights_reserved'] = 'Todos os direitos reservados';

// NOTIFICATION BOXES //
$LNG['settings_saved'] = 'As configurações foram salvas';
$LNG['password_changed'] = 'A senha foi alterada';
$LNG['nothing_changed'] = 'Não houve nenhuma alteração';
$LNG['password_not_changed'] = 'A sua senha não foi alterada.';
$LNG['wrong_current_password'] = 'A senha informada está incorreta.';
$LNG['image_saved'] = 'A imagem foi salva';
$LNG['profile_picture_saved'] = 'A foto do perfil foi salva.';
$LNG['error'] = 'Erro';
$LNG['no_file'] = 'Você não selecionou nenhum arquivo ou os arquivos selecionados estão vazios.';
$LNG['file_exceeded'] = 'O tamanho do arquivo selecionado não deve exceder <strong>%s</strong> MB.';
$LNG['file_format'] = 'O formato do arquivo é inválido. Faça o upload <strong>%s</strong> do formato de arquivo';
$LNG['image_removed'] = 'Imagem removida';
$LNG['profile_picture_removed'] = 'A sua foto de perfil foi removida.';
$LNG['profile_description'] = 'A descrição do perfil deve ter %s caracteres ou menos.';
$LNG['playlist_description'] = 'A descrição da playlist deve ter %s caracteres ou menos.';
$LNG['playlist_name_empty'] = 'O nome da playlist não pode ficar vazio.';
$LNG['changes_saved'] = 'As mudanças foram salvas com sucesso.';
$LNG['valid_email'] = 'Por favor, informe um e-mail válido.';
$LNG['valid_url'] = 'Por favor, informe uma URL válida.';
$LNG['valid_country'] = 'Por favor, informe um país valido';
$LNG['background_changed'] = 'A imagem de fundo foi alterada com sucesso.';
$LNG['background_not_changed'] = 'O plano de fundo não pode ser alterado.';
$LNG['password_too_short'] = 'A senha deve ter ao menos <strong>6</strong> caracteres.';
$LNG['password_not_match'] = 'A senha informada não é idêntica.';
$LNG['username_not_found'] = 'Nós não conseguimos encontrar o usuário informado.';
$LNG['userkey_not_found'] = 'O nome de usuário ou a chave de redefinição estão incorretos. Verifique se você inseriu as informações corretas.';
$LNG['email_reset'] = 'Um email contendo instruções de redefinição de senha foi enviado. Aguarde até 24 horas para receber a mensagem, verifique também o Spam, se não encontrar na sua Caixa de Entrada.';
$LNG['user_deleted'] = 'Usuário excluído';
$LNG['user_has_been_deleted'] = 'O usuário <strong>%s</strong> foi excluído.';
$LNG['user_not_deleted'] = 'O usuário selecionado (ID: %s) não pode ser excluído.';
$LNG['user_not_exist'] = 'O usuário selecionado não existe.';
$LNG['payment_not_exist'] = 'O tipo de pagamento selecionado não existe.';
$LNG['report_not_exist'] = 'O identificador do relatório selecionado não existe.';
$LNG['theme_changed'] = 'Tema alterado';
$LNG['notif_saved'] = 'Notificações alteradas';
$LNG['notif_success_saved'] = 'As notificações foram atualizadas com sucesso.';
$LNG['password_reset'] = 'Você redefiniu sua senha com sucesso. Agora você pode fazer login usando a nova senha.';

// MAIL CONTENT //
$LNG['welcome_mail'] = 'Bem vindo %s';
$LNG['email_footer_unsub'] = '<br><br><span style="color: #aaa;">Este email foi enviado automaticamente, se você não deseja receber este tipo de email <strong>%s</strong> no futuro, por favor <a href="%s">Cancele a inscrição</a>.</span>';
$LNG['email_footer_gen'] = '<br><br><span style="color: #aaa;">Copyright &copy; '.date('Y').' <a href="%s">%s</a>. Todos os direitos reservados.';
$LNG['email_hello'] = 'Olá <strong>%s</strong>,<br><br>';
$LNG['user_created'] = 'Obrigado por se unir <strong>%s</strong><br><br>Seu usuário: <strong>%s</strong><br><br>Você pode fazer login com: <a href="%s" target="_blank">%s</a>'.$LNG['email_footer_gen'];
$LNG['recover_mail'] = 'Recuperação de Senha';
$LNG['recover_content'] = 'Foi solicitada uma recuperação de senha. Se você não solicitou, ignore este e-mail. <br><br>Seu usuário: <strong>%s</strong><br>Seu código de redefinição: <strong>%s</strong><br><br>Você pode redefinir sua senha acessando o seguinte link: <a href="%s" target="_blank">%s</a>'.$LNG['email_footer_gen'];
$LNG['ttl_comment_email'] = '%s comentou na sua track';
$LNG['comment_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong> comentou sobre sua <strong><a href="%s">track.</a></strong>'.$LNG['email_footer_unsub'];
$LNG['ttl_like_email'] = '%s gostou de sua track';
$LNG['like_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong> gostou de sua <strong><a href="%s">track.</a></strong>'.$LNG['email_footer_unsub'];
$LNG['ttl_new_friend_email'] = '%s adicionou você como amigo';
$LNG['new_friend_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong> adicionou você como amigo.'.$LNG['email_footer_unsub'];
$LNG['ttl_copyright_notification'] = 'Solicitação de Reivindicação de Direitos Autorais - %s';
$LNG['copyright_mail_0'] = $LNG['email_hello'].'A sua track <a href="%s">%s</a> foi suspenso devido a uma reivindicação de direitos autorais por <a href="%s">%s</a>. Se você acha que foi um erro, entre em contato. Identificador: %s'.$LNG['email_footer_gen'];
$LNG['copyright_mail_1'] = $LNG['email_hello'].'A track <a href="%s">%s</a> foi suspenso. Obrigado. Identificador: %s'.$LNG['email_footer_gen'];
$LNG['ttl_suspended_account_mail'] = 'A sua conta foi suspensa';
$LNG['suspended_account_mail'] = $LNG['email_hello'].'A sua conta foi suspensa. Se você acha que foi um erro, entre em contato conosco.'.$LNG['email_footer_gen'];
$LNG['ttl_confirm_email'] = 'Confirme o e-mail e sua conta';
$LNG['confirm_email'] = $LNG['email_hello'].'Obrigado por se juntar <strong>%s</strong>. Finalize a sua inscrição em <a href="%s" target="_blank">clicking here</a>.'.$LNG['email_footer_gen'];

// ADMIN PANEL //
$LNG['general_link'] = 'Geral';
$LNG['security_link'] = 'Segurança';
$LNG['manage_users'] = 'Gerenciar Usuários';

$LNG['theme_install'] = 'Para instalar um novo tema, faça o upload no <strong>themes</strong> folder';
$LNG['language_install'] = 'Para instalar um novo idioma, faça o upload no <strong>languages</strong> folder';
$LNG['theme_author_homepage'] = 'Visite a página do autor';
$LNG['theme_version'] = 'Versão';
$LNG['theme_active'] = 'Ativo';
$LNG['theme_activate'] = 'Ativado';
$LNG['by'] = 'Por';

// STREAM //
$LNG['welcome_stream_ttl'] = 'Bem-vindo ao seu Stream';
$LNG['welcome_stream'] = 'Todas as faixas dos seus amigos aparecerão nesta página. Comece fazendo novos amigos.';
$LNG['leave_comment'] = 'Deixe um comentário...';
$LNG['post'] = 'Postar';
$LNG['view_more_comments'] = 'Ver mais comentário';
$LNG['this_track_private'] = 'Esta track é privada';
$LNG['this_track_public'] = 'Esta track é pública';
$LNG['this_playlist_private'] = 'Esta playlist é privada';
$LNG['this_playlist_public'] = 'Esta playlist é pública';
$LNG['delete_this_comment'] = 'Excluir este comentário';
$LNG['delete_this_message'] = 'Excluir esta mensagem';
$LNG['report_this_track'] = 'Reportar esta track';
$LNG['report_this_comment'] = 'Reportar este comentário';
$LNG['load_more'] = 'Carregar mais';
$LNG['view_more'] = 'Visualizar mais';
$LNG['comment_wrong'] = 'Ocorreu um erro. Atualize a página e tente novamente.';
$LNG['comment_too_long'] = 'Desculpe, mas o máximo de caracteres permitido por comentário é <strong>%s</strong>.';
$LNG['comment_error'] = 'Desculpe, não foi possível postar o comentário, atualize a página e tente novamente.';
$LNG['track_hidden_1'] = 'Desculpe, mas esta faixa é privada, apenas o autor da faixa pode visualizar.';
$LNG['track_hidden_2'] = 'Desculpe, mas as configurações de perfil deste autor permitem apenas que seus seguidores vejam esta faixa.';
$LNG['track_hidden_1_ttl'] = $LNG['track_hidden_2_ttl'] = 'Track Privada';
$LNG['track_suspended_1'] = 'Desculpe, mas esta track foi desativada. Se você acha que foi um erro, entre em contato conosco.';
$LNG['track_suspended_1_ttl'] = 'Track desativada';
$LNG['playlist_hidden'] = 'Desculpe, mas esta lista de reprodução é privada, apenas o autor da lista pode visualizar.';
$LNG['playlist_hidden_ttl'] = 'Playlist privada';
$LNG['comment'] = 'Comentar';
$LNG['share'] = 'Compartilhar';
$LNG['autoplay'] = 'Autoplay';
$LNG['add_to'] = 'Adicionar a';
$LNG['buy'] = 'Comprar';
$LNG['download'] = 'Download';
$LNG['new_playlist'] = 'Criar nova playlist';
$LNG['cancel'] = 'Cancelar';
$LNG['close'] = 'Fechar';
